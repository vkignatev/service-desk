...
public class LocationServiceTest extends GenericTest<Location, LocationDTO> {

    public LocationServiceTest() {
        super();
        repository = Mockito.mock(LocationRepository.class);
        mapper = Mockito.mock(LocationMapper.class);
        service = new LocationService((LocationRepository) repository, (LocationMapper) mapper);
    }
